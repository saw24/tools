...
const appState = {
    ...
    entityType: 'organisationUnits', // 'organisationUnits' or 'users'
    wb: null, // Workbook
...
const FIELD_DEFINITIONS = {
    ...
    users: [
        { id: 'username', name: 'Nom d\'utilisateur (Requis)', required: true },
        { id: 'firstName', name: 'Prénom (Requis)', required: true },
        { id: 'surname', name: 'Nom (Requis)', required: true },
        { id: 'email', name: 'Email', required: false },
        { id: 'phoneNumber', name: 'Téléphone', required: false },
        { id: 'password', name: 'Mot de Passe', required: false },
        { id: 'userRoles', name: 'Rôles (séparés par virgule)', required: false },
